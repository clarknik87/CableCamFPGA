...
#define AXI_SEVENSEGMENTDRIVER_S_AXI_SLV_REG0_OFFSET 0
#define AXI_SEVENSEGMENTDRIVER_S_AXI_SLV_REG1_OFFSET 4
#define AXI_SEVENSEGMENTDRIVER_S_AXI_SLV_REG2_OFFSET 8
#define AXI_SEVENSEGMENTDRIVER_S_AXI_SLV_REG3_OFFSET 12
