...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
user.org:user:AXI_HallEffectSensor:2.0\
user.org:user:AXI_SevenSegmentDriver:2.0\
user.org:user:PWMGenerator:2.0\
...
proc create_root_design { parentCell } {
  ...
  set digitseg [ create_bd_port -dir O -from 0 -to 6 digitseg ]
  set drive_motor_pwm [ create_bd_port -dir O drive_motor_pwm ]
  set hall_effect [ create_bd_port -dir I hall_effect ]
  ...
  # Create instance: AXI_HallEffectSensor_0, and set properties
  set AXI_HallEffectSensor_0 [ create_bd_cell -type ip -vlnv user.org:user:AXI_HallEffectSensor:2.0 AXI_HallEffectSensor_0 ]

  # Create instance: AXI_SevenSegmentDriv_0, and set properties
  set AXI_SevenSegmentDriv_0 [ create_bd_cell -type ip -vlnv user.org:user:AXI_SevenSegmentDriver:2.0 AXI_SevenSegmentDriv_0 ]

  # Create instance: PWMGenerator_0, and set properties
  set PWMGenerator_0 [ create_bd_cell -type ip -vlnv user.org:user:PWMGenerator:2.0 PWMGenerator_0 ]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M11_AXI [get_bd_intf_pins AXI_SevenSegmentDriv_0/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M11_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M12_AXI [get_bd_intf_pins AXI_HallEffectSensor_0/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M12_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M13_AXI [get_bd_intf_pins axi_timer_0/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M13_AXI]
  connect_bd_intf_net -intf_net microblaze_0_debug [get_bd_intf_pins mdm_1/MBDEBUG_0] [get_bd_intf_pins microblaze_0/DEBUG]
  connect_bd_intf_net -intf_net microblaze_0_dlmb_1 [get_bd_intf_pins microblaze_0/DLMB] [get_bd_intf_pins microblaze_0_local_memory/DLMB]
  connect_bd_intf_net -intf_net microblaze_0_ilmb_1 [get_bd_intf_pins microblaze_0/ILMB] [get_bd_intf_pins microblaze_0_local_memory/ILMB]

  # Create port connections
  connect_bd_net -net AXI_HallEffectSensor_0_an [get_bd_ports digitan] [get_bd_pins AXI_HallEffectSensor_0/an]
  connect_bd_net -net AXI_HallEffectSensor_0_seg [get_bd_ports digitseg] [get_bd_pins AXI_HallEffectSensor_0/seg]
  ...
  connect_bd_net -net PWMGenerator_0_drive_speed [get_bd_pins AXI_HallEffectSensor_0/SET_SPEED] [get_bd_pins PWMGenerator_0/drive_speed]
  ...
  connect_bd_net -net hall_effect_1 [get_bd_ports hall_effect] [get_bd_pins AXI_HallEffectSensor_0/HALL_EFFECT]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_clk_wiz_1_100M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins AXI_HallEffectSensor_0/s_axi_aclk] [get_bd_pins AXI_SevenSegmentDriv_0/s_axi_aclk] [get_bd_pins PWMGenerator_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_uartlite_Storm32/s_axi_aclk] [get_bd_pins axi_uartlite_usb/s_axi_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/M06_ACLK] [get_bd_pins microblaze_0_axi_periph/M07_ACLK] [get_bd_pins microblaze_0_axi_periph/M08_ACLK] [get_bd_pins microblaze_0_axi_periph/M09_ACLK] [get_bd_pins microblaze_0_axi_periph/M10_ACLK] [get_bd_pins microblaze_0_axi_periph/M11_ACLK] [get_bd_pins microblaze_0_axi_periph/M12_ACLK] [get_bd_pins microblaze_0_axi_periph/M13_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins pwm_interpreter_0/s00_axi_aclk] [get_bd_pins pwm_interpreter_1/s00_axi_aclk] [get_bd_pins pwm_interpreter_2/s00_axi_aclk] [get_bd_pins pwm_interpreter_3/s00_axi_aclk] [get_bd_pins pwm_interpreter_4/s00_axi_aclk] [get_bd_pins pwm_interpreter_5/s00_axi_aclk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A80000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs AXI_HallEffectSensor_0/S_AXI/S_AXI_reg] SEG_AXI_HallEffectSensor_0_S_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x44A70000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs AXI_SevenSegmentDriv_0/S_AXI/S_AXI_reg] SEG_AXI_SevenSegmentDriv_0_S_AXI_reg
